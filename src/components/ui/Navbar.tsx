...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="relative z-50 w-full pt-3 px-3 sm:px-0"
    >
        ...
        <div className="glass-panel flex h-14 sm:h-16 items-center justify-between px-3 sm:px-5 relative overflow-hidden">
          ...
          >
            <motion.div
              ...
              className="relative flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-lg sm:rounded-xl bg-gradient-to-br from-neon-green/20 to-electric-blue/20 border border-neon-green/25"
            >
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.div
                        ...
                        className="absolute inset-0 rounded-lg sm:rounded-xl border border-neon-green/30 bg-gradient-to-r from-neon-green/18 via-electric-blue/12 to-neon-green/8"
                        style={{
                          boxShadow:
      ...
      <motion.div
        ...
        className="mt-3 h-px w-full origin-center"
        style={{
          background:
