  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div
          className={`shrink-0 mt-0.5 flex h-8 w-8 items-center justify-center rounded-xl ${c.bg}`}
        >
        ...
        <div className="min-w-0">
          ...
          {card.metric && (
            <span
              className={`inline-block mt-2 text-xs font-mono font-bold ${c.iconColor}`}
            >
              {card.metric}
            </span>
          )}
...
export default function PlanDashboard() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      if (!storedPlan) {
        const reportId =
          sessionStorage.getItem("bodysync_reportId") ||
        ...
        <div className="glass-panel w-full max-w-3xl p-6 sm:p-8">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div className="space-y-2">
              ...
              <div className="skeleton-shimmer h-2.5 w-56 rounded-md" />
            </div>
            <Loader2 className="ml-auto h-5 w-5 animate-spin text-electric-blue" />
          </div>
  ...
  if (!plan) {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center gap-6 px-4">
        <div className="glass-panel-hover max-w-md p-8 text-center">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 mx-auto rounded-xl py-3 px-6 font-bold bg-gradient-to-r from-neon-green to-electric-blue text-black hover:shadow-[0_0_30px_rgba(57,255,20,0.2)] transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
  ...
  return (
    <motion.div
      ...
      className="relative space-y-10 py-10 md:py-14"
    >
      {/* Background */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute left-1/4 top-0 h-[470px] w-[520px] rounded-full bg-neon-green/[0.04] blur-[125px]"
        />
        <motion.div
          animate={{ x: [0, -16, 10, 0], y: [0, 8, -8, 0] }}
          transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }}
          className="absolute right-0 top-60 h-[320px] w-[420px] rounded-full bg-electric-blue/[0.04] blur-[105px]"
        />
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <motion.div
          ...
          className="glass-panel-hover px-4 py-2.5 flex items-center gap-2.5"
        >
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="glass-panel-hover p-3 text-center"
            >
      ...
      {/* ── Insight Cards ── */}
      {ba &&
        (ba.positiveIndicators.length > 0 || ba.areasToImprove.length > 0) && (
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Key findings from your body analysis
                </p>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              {ba.areasToImprove.map((card, i) => (
                <InsightCardUI
                  key={`imp-${i}`}
                  card={card}
                  index={ba.positiveIndicators.length + i}
                />
              ))}
            </div>
          </div>
              ...
              {[
                {
                  ...
                  color: "#0FF0FC",
                  pct: Math.round(
                    (plan.macros.protein / totalMacroGrams) * 100,
                  ),
                },
                {
                  label: "CARB",
                  ...
                  color: "#39FF14",
                  pct: Math.round((plan.macros.carbs / totalMacroGrams) * 100),
                },
                {
                  label: "FAT",
                  value: plan.macros.fats,
                  color: "#8A2BE2",
                  pct: Math.round((plan.macros.fats / totalMacroGrams) * 100),
                },
              ].map((macro) => (
          ...
          >
            <div className="grid grid-cols-3 gap-4">
              {[
                {
                  label: "Fat Loss",
                  value: nt.fatLossCalories,
                  color: "#EF4444",
                },
                {
                  label: "Maintenance",
                  value: nt.maintenanceCalories,
                  color: "#0FF0FC",
                },
                {
                  label: "Muscle Gain",
                  value: nt.muscleGainCalories,
                  color: "#39FF14",
                },
              ].map((zone) => (
          ...
          <div className="space-y-6 pt-2">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Optimized daily nutrition timing
                </p>
              </div>
            </motion.div>
              ...
              {plan.mealPlan.meals.map((meal, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 pt-1">
                    <span className="text-xs text-electric-blue font-bold">
                      {meal.calories} kcal
                    </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {plan.mealPlan.foodsToPrioritize &&
                plan.mealPlan.foodsToPrioritize.length > 0 && (
                  <motion.div
                    initial={{ opacity: 0, y: 8 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {plan.mealPlan.foodsToPrioritize.map((f, i) => (
                        <span
                          key={i}
                          className="text-xs bg-neon-green/10 text-neon-green rounded-lg px-3 py-1.5 border border-neon-green/10"
                        >
                          {f}
                        </span>
                      ))}
              ...
              {plan.mealPlan.foodsToReduce &&
                plan.mealPlan.foodsToReduce.length > 0 && (
                  <motion.div
                    initial={{ opacity: 0, y: 8 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {plan.mealPlan.foodsToReduce.map((f, i) => (
                        <span
                          key={i}
                          className="text-xs bg-yellow-500/10 text-yellow-400 rounded-lg px-3 py-1.5 border border-yellow-500/10"
                        >
                          {f}
                        </span>
                      ))}
        ...
        <div className="space-y-4 pt-2">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Detailed breakdown of your composition
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <AnalysisSection
              ...
              content={ba.trainingRecommendations}
              icon={Target}
              color="text-electric-blue"
              delay={0.54}
            />
            <AnalysisSection
              ...
              content={ba.nutritionRecommendations}
              icon={Utensils}
              color="text-deep-purple"
              delay={0.56}
            />
